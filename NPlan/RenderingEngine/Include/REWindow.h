...
#ifdef WIN32
class REWinDeviceSurface: public RESurface
{
public:
...
class RELayerWinDeviceSurface: public REWinDeviceSurface
{
public:
...
#ifdef USE_DDRAW
class REDDrawSurface: public RESurface
{
public:
...
class REGlSurface: public RESurface
{
public:
...
class KGlesEnv;
class REGLESSurface: public RESurface
{
public:
...
class RESkiaGLSurface: public RESurface
{
public:
...
class REGLLayerWinDeviceSurface: public REGlSurface
{
public:
...
#ifdef ANDROID_NDK
class REAndroidSurface: public RESurface
{
public:
...
class REQtSoftSurface: public RESurface
{
public:
...
class REIOSSurface: public RESurface
{
public:
