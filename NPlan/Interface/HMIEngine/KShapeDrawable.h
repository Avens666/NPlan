...
class KRectShape : public KShape
{	
protected:
...
//椭圆形
class KOvalShape : public KRectShape
{
public:
	KOvalShape();
...
//扇形
class KArcShape : public KRectShape
{
protected:
	int m_start_angle;
	int m_sweep_angle;
...
//圆角矩形
class KRoundRectShape : public KRectShape
{
protected:
...
//圆形
class KCircleShape : public KShape
{
protected:
	float m_cx;    //圆心x坐标
	float m_cy;	//圆心y坐标
...
//线
class KLineShape : public KShape
{
protected:
	REPoint m_p1;
	REPoint m_p2;
...
//多边形、折线
class KPolygonShape : public KShape
{
protected:
...
//路径
class KPathShape : public KShape
{
protected:
...
class KShapeDrawable : public KDrawable
{
protected:
	KShape* m_p_shape;
...
class KSVGDrawable : public KDrawable
{
protected:
