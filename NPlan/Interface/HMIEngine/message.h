...
class KMessageKey : public KMessage
{
public:
	KMessageKey();
	virtual ~KMessageKey(){};
...
class KMessagePos : public KMessage
{//作为有轨迹的消息的基类，
public:
	KMessagePos();
	virtual ~KMessagePos(){};
...
class KMessageMouseWheel : public KMessagePos
{
public:
	KMessageMouseWheel();
...
class KMessageMouse : public KMessagePos
{
public:
	KMessageMouse();
...
class KMessageTouch : public KMessagePos
{
public:
...
class KMessage3Dx : public KMessage
{
public:
	virtual ~KMessage3Dx(){};
...
class KMessageInput : public KMessageKey
{
public:
	KMessageInput();
...
class KMessageEditTextIME : public KMessageInput
{
public:
	KMessageEditTextIME();
...
class KMessageDrag : public KMessagePos
{
public:
	KMessageDrag();
