...
class KView : public KShowObject, public sigslot::has_slots<>, public boost::enable_shared_from_this<KView>
{
public:
	KView();
	virtual ~KView();
	...
	KVIEWTYPE getType();
	//创建drawable的函数
    void createTextDrawableHelper(KTextDrawable_PTR* txt,kn_string str, int fontsize, kn_int x,kn_int y, kn_int w, kn_int h, REColor r = RE_ColorBLACK, REPaint::Align align= REPaint::kLeft_Align);
