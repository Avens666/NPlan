...
class CPropertyBase: public KObject 
{
public:
	CPropertyBase(void);
	~CPropertyBase(void);
...
// View位置移动
class CPropertyPos: public CPropertyBase
{
public:
...
// View透明度
class CPropertyOpacity: public CPropertyBase
{
public:
...
class CPropertyPara: public CPropertyBase
{
public:
...
// View缩放
class CPropertyRect: public CPropertyBase
{
public:
...
// View旋转
class CPropertyAngle: public CPropertyBase
{
public:
...
// View裁剪区
class CPropertyClip: public CPropertyBase
{
public:
...
// StaticView文字移动
class CPropertyText: public CPropertyBase
{
public:
...
class CPropertyList: public KObject
{
...
class CDataSync: public KObject
{
public:
	CDataSync(void);
	~CDataSync(void);
