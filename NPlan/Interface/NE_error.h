...
// #define  RESULT(CLASS, COM, FAC, CODE) (KNRESULT)((CLASS << 29) | (COM << 25) | (FAC << 16) | CODE) 
...
enum KNSYSCOM
{
    ...
    SC_UNKNOW			= 0xF,	// 未知的
    SC_HMI				= 1,	// HMI
    SC_MAPDISPLAY		= 2,	// 地图显示
    SC_POI				= 3,	// POI查询
    SC_POSITION			= 4,	// 地图匹配
    SC_ROUTEPLAN		= 5,	// 路线规划
    SC_GUIDE			= 6,	// 路线引导
    SC_SIMULATION		= 7,	// 模拟驾驶
    SC_DATAMANAGER		= 8,	// 数据管理
    SC_MAPDATAIO		= 9,	// 数据加载
    SC_SOUNDENGINE		= 10,	// 声音引擎
    SC_RENDERINGENGINE	= 11,	// 渲染引擎
    SC_BASELIB			= 12,	// BaseLib组件
    SC_CORE				= 13,	// Core组件
    SC_SYSMONITOR		= 14,	// 系统监测
};
