...
kn_bool KLayer::Create(int iWidth, int iHeight, REBitmap::Config format)
{
...
void KLayer::Draw(IRESurface*  pDstSurface )
{
	// Pageview 绘制在 layer上

}
 
void KLayer::Draw(IRESurface* pDstSurface , RERect& rect)
{

	
}

kn_bool KLayer::DoMessage(KMessage* pMsg)
{
	kn_bool ret = false;

	//MyTraceA("KLayer::DoMessage pMsg msgtype = %d", pMsg->msgtype);
